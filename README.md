...
* **Rastreamento de Itens:** Exibição e ordenação dos itens obtidos (Inventário) por preço.
...
1.  Acesse a seção **[Releases]** do nosso repositório no GitHub.
2.  Baixe o arquivo `SimuladorCSCase.exe` da versão mais recente (`v1.0.0`).
3.  Execute o arquivo diretamente no seu computador (somente Windows).
